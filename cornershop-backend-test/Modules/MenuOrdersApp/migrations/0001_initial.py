# Generated by Django 3.0.8 on 2021-07-24 04:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(blank=True, db_column='Key', max_length=7, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyuser', models.SmallIntegerField(blank=True, db_column='CreatedByUser', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='Id', primary_key=True, serialize=False)),
                ('idmeal', models.IntegerField(db_column='IdMeal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('iduser', models.SmallIntegerField(db_column='IdUser')),
                ('idpermission', models.SmallIntegerField(db_column='IdPermission')),
            ],
            options={
