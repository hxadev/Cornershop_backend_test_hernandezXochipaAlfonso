...
SECRET_KEY = getenv("SECRET_KEY", default="1234")
...
INSTALLED_APPS = [
    ...
    "backend_test.utils",
    "backend_test",
    'Modules.MenuOrdersApp',
    "Modules.ApiWebhookWhatsapp"
]
...
TEMPLATES = [
    {
        ...
        "DIRS": ["./../Modules/MenuOrdersApp/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
# Language code of Chile
LANGUAGE_CODE = "es-mx"

# TIME_ZONE = "UTC"
# Chilean Time Zone Configured
...
# SLACK GROUP TO CORNERSHOP TEST
SLACK_TOKEN = "xoxb-1474977575873-2323245919889-xKIccSvaU5qIooU5sjZQHCUb"

SLACK_HOOK = "https://hooks.slack.com/services/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"
