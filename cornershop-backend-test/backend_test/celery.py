...
app = Celery("backend_test", broker="redis://redis:6379/2")

app.conf.beat_schedule = {                          ## slack_reminder tasks
    'send-reminder-slack': {                        ## that is configured to execute dayli al 7:10 am
        'task': 'tasks.slack_reminder',
